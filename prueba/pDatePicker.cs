...
{
    public class pDatePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = CapaPresentacion.Properties.Resources.calendarDark;
                else calendarIcon = CapaPresentacion.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
